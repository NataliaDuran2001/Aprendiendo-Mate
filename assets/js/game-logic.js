...
function checkSelectedAnswer() {
    ...
    if (sAnswer == bpmQCurrent[1]) {
        ...
        if (bpmCQ < bpmQno) {
            ...
            // Log to console for debugging
            // console.log("Bien hecho! - you scored " +  bpmScoreArray[0] + " out of " + bpmScoreArray[1] + "!") //
            ...
            if (checkHighScore(highScore, bpmScoreArray)) {
                ...
                $("#modal-feedback-heading-text").text("Asombroso - Nuevo puntaje alto!!!");
                ...
                if ((bpmScoreArray[0]) < 4) {
                    ...
                    $("#modal-feedback-heading-text").text("Mala suerte, intenta otra vez!!");
                    // Play unlucky sound
                    soundUnlucky.play();
                } else {
                    // Otherwise set modal heading to Bien hecho
                    $("#modal-feedback-heading-text").text("Bien hecho!!");
                    // Play Bien hecho sound
                    soundWellDone.play();
                }
            }
            // Set modal body text to score out of number of questions asked
            $("#modal-feedback-body-text").text("Tu puntaje es " +  bpmScoreArray[0] + " de " + bpmScoreArray[1] + "!");
